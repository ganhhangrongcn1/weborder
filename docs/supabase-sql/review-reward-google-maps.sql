-- Source of truth: supabase/migrations/20260801090000_review_reward_google_maps.sql
-- Adds Google Maps review claims, using branch_uuid instead of partner_order_id.
