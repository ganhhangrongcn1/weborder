...
begin
  ...
  if v_reviewer.branch_uuid is not null
    and v_claim.branch_uuid is distinct from v_reviewer.branch_uuid then
    raise exception 'Admin không được duyệt yêu cầu của chi nhánh khác.';
  end if;
