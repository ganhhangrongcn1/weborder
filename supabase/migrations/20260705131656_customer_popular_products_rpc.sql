...
-- Aggregates website orders and mapped partner orders in one request.
-- Safe to run multiple times.
-- Prerequisite: public.normalize_order_counting_status(text).

create index if not exists orders_customer_popular_created_at_idx
