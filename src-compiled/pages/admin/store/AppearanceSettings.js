...
import AppearanceCropModal from "./AppearanceCropModal.js";
import AppearanceBlockList from "./AppearanceBlockList.js";
import AppearanceBlockEditor from "./AppearanceBlockEditor.js";
import { catalogConfigRepository, CATALOG_CONFIG_KEYS, syncAppearanceCatalogToSupabase } from "../../../services/repositories/catalogConfigRepository.js";
import { BANNER_WIDTH, BANNER_HEIGHT, HOME_BLOCKS, HOME_BLOCK_DEFAULTS, buildDeliveryBranchApps, isTopBannerItem, normalizeAction } from "./appearanceSettings.utils.js";
...
function calculateFlashSaleWarnings({
  flashSaleBlock,
  smartPromotions = [],
  products = []
}) {
  ...
  const validPromos = activePromos.filter(promo => {
    ...
    return matchedProducts.some(product => {
      ...
      const salePrice = rewardType === "fixed_discount" ? Math.max(basePrice - rewardValue, 0) : Math.max(basePrice * (1 - rewardValue / 100), 0);
...
export default function AppearanceSettings({
  ...
  const blockOrder = useMemo(() => {
    ...
    HOME_BLOCKS.forEach((item, index) => {
      const idx = item.id === "hero" ? homeContent.findIndex(contentItem => isTopBannerItem(contentItem)) : homeContent.findIndex(contentItem => contentItem.id === item.id);
  ...
  const getBlockData = blockId => {
    if (blockId === "hero") return {
      id: "hero",
      active: topBannerItems.some(item => item.active !== false)
    };
    return homeContent.find(item => item.id === blockId) || HOME_BLOCK_DEFAULTS.find(item => item.id === blockId) || {
      id: blockId,
      active: true
    };
  };
  const updateHomeContent = (id, patch) => {
    ...
    setHomeContent(current => {
      ...
      const fallback = HOME_BLOCK_DEFAULTS.find(item => item.id === id) || HOME_BLOCKS.find(item => item.id === id) || {
        id
      };
      return [...current, {
        ...fallback,
  ...
  const setBlockActive = (blockId, checked) => {
    onDirtyChange?.(true);
    if (blockId === "hero") {
      setHomeContent(current => current.map(item => isTopBannerItem(item) ? {
        ...item,
        active: checked
      } : item));
      return;
    }
    updateHomeContent(blockId, {
      active: checked
    });
  };
  ...
  const reorderTopBanners = nextTopBanners => {
    onDirtyChange?.(true);
    let cursor = 0;
    setHomeContent(current => current.map(item => {
  ...
  const applyCroppedImage = async () => {
    ...
    try {
      ...
      const croppedFile = new File([blob], cropSourceFile.name || `image_${Date.now()}.webp`, {
        type: "image/webp"
      });
      // Keep localStorage payload smaller to reduce quota overflow risk.
      const result = await processUploadImage(croppedFile, {
        maxWidth: 960,
        quality: 0.62
      });
      try {
  ...
  const deliveryBranchApps = selectedBlockId === "deliveryApps" ? buildDeliveryBranchApps(selectedNonHeroBlock, branches) : [];
  const flashSaleWarnings = selectedBlockId === "flashSale" ? calculateFlashSaleWarnings({
    flashSaleBlock: selectedNonHeroBlock,
    smartPromotions,
    products
  }) : [];
  ...
  return /*#__PURE__*/_jsxs("section", {
    className: "admin-appearance-page",
    children: [/*#__PURE__*/_jsxs("div", {
      className: "admin-appearance-page-head",
      children: [/*#__PURE__*/_jsxs("div", {
        children: [/*#__PURE__*/_jsx("h1", {
          children: "Qu\u1EA3n l\xFD giao di\u1EC7n"
        }), /*#__PURE__*/_jsx("p", {
          children: "Qu\u1EA3n l\xFD c\xE1c giao di\u1EC7n hi\u1EC3n th\u1ECB tr\xEAn website v\xE0 \u1EE9ng d\u1EE5ng."
        })]
        ...
        children: isSaving ? "Đang lưu..." : uiDirty ? "Lưu thay đổi" : "Đã đồng bộ"
      })]
    }), saveMessage ? /*#__PURE__*/_jsx("p", {
      className: "text-sm text-slate-600",
      children: saveMessage
    }) : null, /*#__PURE__*/_jsxs("div", {
      className: "admin-appearance-stats",
      "aria-label": "T\u1ED5ng quan giao di\u1EC7n",
      children: [/*#__PURE__*/_jsxs(AdminCard, {
        variant: "compact",
        className: "admin-appearance-stat is-active",
        children: [/*#__PURE__*/_jsx("span", {
          children: "T\u1EA5t c\u1EA3"
        }), /*#__PURE__*/_jsx("strong", {
          children: appearanceStats.total
        ...
        variant: "compact",
        className: "admin-appearance-stat",
        children: [/*#__PURE__*/_jsx("span", {
          children: "\u0110ang hi\u1EC3n th\u1ECB"
        }), /*#__PURE__*/_jsx("strong", {
          children: appearanceStats.visible
        }), /*#__PURE__*/_jsx(AdminBadge, {
          tone: "success",
          children: "B\u1EADt"
        })]
        ...
        children: [/*#__PURE__*/_jsx("span", {
          ...
          children: appearanceStats.hidden
        }), /*#__PURE__*/_jsx(AdminBadge, {
          tone: "neutral",
          children: "T\u1EAFt"
        })]
        ...
        className: "admin-appearance-stat",
        children: [/*#__PURE__*/_jsx("span", {
          children: "Banner \u0111\u1EA7u trang"
        }), /*#__PURE__*/_jsx("strong", {
          children: appearanceStats.heroItems
        }), /*#__PURE__*/_jsx(AdminBadge, {
          tone: "info",
          children: "\u1EA2nh"
        })]
      ...
      className: "admin-panel admin-appearance-layout",
      children: [/*#__PURE__*/_jsx(AppearanceBlockList, {
        search: search,
        setSearch: setSearch,
      ...
      }), /*#__PURE__*/_jsx(AppearanceBlockEditor, {
        uiDirty: uiDirty,
        selectedBlockId: selectedBlockId,
    ...
    }), /*#__PURE__*/_jsx(AppearanceCropModal, {
      open: cropModalOpen,
