...
export default function InventoryCountManager({ rows = [], warehouses = [], items = [], units = [], canWrite = false, canManage = false, canCancel = false, canCount = false, mutationStatus = "idle", mutationMessage = "", onCreateAndStart, onRecordAndSubmit, onApproveAndComplete, onCancel, onCompleteApproved, warehouseSelectionLocked = false }) {
