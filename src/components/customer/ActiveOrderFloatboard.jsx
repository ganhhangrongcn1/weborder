...
export default function ActiveOrderFloatboard({
  ...
  if (collapsed) {
    return (
      <div className={`active-order-floatboard-wrap active-order-floatboard-wrap--compact${raised ? " is-raised" : ""}${hasUnreadUpdate ? " has-unread" : ""}`} aria-live="polite">
        <button
          type="button"
  ...
  return (
    <aside className={`active-order-floatboard-wrap${raised ? " is-raised" : ""}`} aria-label={`Tóm tắt đơn đang xử lý ${orderCode}`} aria-live="polite">
