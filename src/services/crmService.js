  ...
  const customers = allPhones
    .map((phone) => {
      ...
      return {
        ...
        otherAdjustPoints,
        currentPoints,
        registeredCustomer: isRegisteredProfile(registeredUser) || Boolean(crmAnalyticsCustomer?.registeredCustomer),
  ...
  const customers = (crmAnalytics?.customers || [])
    .map((analyticsCustomer) => {
      ...
      return {
        ...
        otherAdjustPoints: 0,
        currentPoints,
        registeredCustomer: isRegisteredProfile(registeredUser) || Boolean(analyticsCustomer.registeredCustomer),
